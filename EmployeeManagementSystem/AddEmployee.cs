    ...
    public partial class AddEmployee : UserControl
    {
        ...
        public void displayEmployeeData()
        {
            try
            {
                ...
                dataGridView1.DataSource = listData; // Bind the list to DataGridView
            }
            catch (Exception ex)
            {
                        ...
                        using (SqlCommand checkEm = new SqlCommand(checkEmID, connect))
                        {
                            ...
                            else
                            {
                                ...
                                using (SqlCommand cmd = new SqlCommand(insertData, connect))
                                {
                                    ...
                                    cmd.Parameters.AddWithValue("@status", addEmployee_Sts.Text.Trim());
        ...
        private void addEmployee_import_btn_Click(object sender, EventArgs e)
        {
            try
            {
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.RowIndex != -1)
            {
                ...
                addEmployee_Sts.Text = row.Cells[8].Value.ToString();
            }
        }
        ...
        public void clearFields()
        {
            ...
            addEmployee_Sts.SelectedIndex = -1;
            addEmployee_picture.Image = null;
        }
